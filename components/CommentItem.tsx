...
export default function CommentItem({
  ...
  return (
    <div className="bg-cyan-500 rounded-lg p-4 sm:p-8 w-full transition-all duration-300 hover:shadow-xl min-h-[250px] sm:min-h-[300px] flex items-center mx-auto max-w-sm sm:max-w-4xl">

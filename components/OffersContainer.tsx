...
export default function OffersContainer() {
  const offers = [
    ...
    },
    {
      ...
      description:
        "Відпочинок на гірськолижних курортах – один із найпопулярніших способів провести відпустку в русі та отримати масу приємних спогадів та відмінний заряд бадьорості. Туристична агенція Coral Travel пропонує гірськолижні тури на будь-який смак.",
      image: skis,
    },
    {
      id: 4,
    ...
    <section className="bg-cyan-500 py-16 px-4">
      <div className="max-w-5xl mx-auto">
        <h1 className="text-4xl md:text-5xl font-semibold text-white text-center mb-12">
          Туристична агенція Coral Travel пропонує
        </h1>
